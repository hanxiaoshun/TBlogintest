...
from code.taobao import TaoBaoLive
import random
import logging
...
@app.route('/get_xcode', methods=['POST'], endpoint='get_xcode')
@login_required
def get_xcode():
    return taobao.get_xcode()

@app.route('/finish_xcode', methods=['POST'], endpoint='finish_xcode')
@login_required
def finish_xcode():
    return taobao.finish_xcode()

@app.route('/phone_captcha_Code', methods=['POST'], endpoint='phone_captcha_Code')
@login_required
def phone_captcha_Code():
    phone_code = request.form['phone_code']
    return taobao.phone_captcha_Code(phone_code)
